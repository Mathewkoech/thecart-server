    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('regular', 'regular'), ('rider', 'rider'), ('operations', 'Operations Admin')], default='regular', help_text='Designates the role of the user in the system - For Authorization', max_length=20, verbose_name='user role')),
