...
class TimeStampedModelMixin(models.Model):
    ...
    These fields are:
    - created_at: this is the timestamp when the model instance was created
    - modified_at: this is the timestamp when the model instance was
    last modified
    - created_by: this is the User instance, that created the object
    - modified_by: this is the User instance that last modified the object
    """
